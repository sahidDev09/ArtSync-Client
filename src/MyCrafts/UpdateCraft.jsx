...
const UpdateCraft = () => {
  ...
  useEffect(() => {
    fetch(`https://art-sync-server.vercel.app/updatecraft/${id}`)
      .then((res) => res.json())
      .then((data) => {
        setUpCraft(data);
      });
        ...
        <form onSubmit={handleUpdate} className=" grid md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-4">
            <label className="input input-bordered flex items-center gap-2">
              ...
              <select name="scustom" className=" w-full bg-transparent">
                <option disabled selected>
                  {scustom}
                </option>
                <option>Yes</option>
            ...
            <label className="input input-bordered flex items-center gap-2">
              ...
              <select name="stock" className=" w-full bg-transparent">
                <option disabled selected>
                  {stock}
                </option>
